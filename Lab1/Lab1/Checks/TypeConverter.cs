    ...
    class TypeConverter
    {
        ...
        public static string EditingString(string symbol, string address, string command, string length, string operand1, string operand2)
        {
            ...
            if (symbol == "H")
            {
                ...
                final = final + "  " + address;
                final = final + "  " + command;
                final = final + "  " + TypeConverter.ToSixChars(TypeConverter.DecToHex(Convert.ToInt32(operand1)));
                return final;
            }
            else if (symbol == "T")
            {
        ...
        public static string ToASCII(string str)
        {
            ...
            {
                result = result + TypeConverter.DecToHex(Convert.ToInt32(textBytes[i]));
            }
            return result;
        }
